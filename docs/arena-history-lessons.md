# Arena rules engine — archived history and lessons

Moved out of `docs/arena-rules-worklist.md` on 10 Sep 2026 so that the worklist
can stay short and current. This file keeps the round-by-round build notes,
merged increments and lessons learned.

For active priorities, start with `docs/arena-rules-worklist.md` and
`docs/arena-next-session-prompt.md`.
