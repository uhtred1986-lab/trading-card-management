...
**Status: brief, not built (8 Sep 2026). Branch `feature/arena-rules-records` carries this file, the prototype and `docs/CLAUDE-TASK.md`.** Written to be executed by Claude Code in this repository.
