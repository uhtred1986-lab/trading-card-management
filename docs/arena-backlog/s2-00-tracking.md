...
- `npm run arena:tally` and `npm run arena:readings` baselines recorded in the worklist before and after each increment; the stage summary names the wordings each primitive unlocked.
