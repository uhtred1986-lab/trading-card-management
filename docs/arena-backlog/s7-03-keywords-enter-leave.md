---
title: Arena: keywords.rules bodies — hook group B — entering, leaving and after a skill
...
stage: 7
---
**Source:** plan Stage 7; the hook contract issue (this depends on it); hooks in this group: **onEnter, onLeave, afterSkill, activeStep**; `src/lib/arena/glossary.ts` for each keyword's meaning and the engine's current approximation; rule manual §22; `scripts/verify/keywords.ts`.

**Candidate keywords** (confirm against the inventory — a keyword belongs to the group whose hooks its body needs, and some need two groups; move it to the later one): [Arrival], [Field], [Wish], [Revive], [Successor], [Overlord], [Rejuvenate], [Z-Awaken], [Z-Stack], [Dragon Ball], [Wormhole], [Invoker], [Heroic], [Villainous].
