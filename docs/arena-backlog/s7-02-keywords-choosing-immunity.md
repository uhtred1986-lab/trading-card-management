---
title: Arena: keywords.rules bodies — hook group A — choosing, immunity and KO by effect
...
**Candidate keywords** (confirm against the inventory — a keyword belongs to the group whose hooks its body needs, and some need two groups; move it to the later one): [Barrier], [Unique], [Indestructible], [Aegis], [Deflect], [Critical], [Strike], [Victory Strike], [Warrior of Universe 7], [Servant], [Alliance].
