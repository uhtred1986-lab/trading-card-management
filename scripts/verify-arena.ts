...
const SUITES = ["text", "setup", "battles", "compiler", "keywords", "readings", "wordings", "workflow", "contract", "deck-api", "language", "lang", "rulesets", "board-words", "primer", "game-page", "probe", "ai-vm", "vm"];
