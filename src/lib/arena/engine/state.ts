...
import { NO_RULES, type Amount, type AmountAttr, type CardScripts, type Cond, type Op, type Ref, type Script, type ScriptArea, type ScriptFrame, type Selector, type Side } from "./script";
import type {
  Area,
  CardDef,
  CardFace,
